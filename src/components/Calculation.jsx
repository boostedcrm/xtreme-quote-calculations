...
export default function Calculation({
  ...
  function calculateTotalCost() {
    ...
    let grossProfitGoal = (totalCost - miscellaneousCost) * 2;
    ...
    let commission =
      (commissionPercentage / 100) * (grossProfitGoal + miscellaneousCost);
    let minimumBidToCustomer = grossProfitGoal + miscellaneousCost + commission;
